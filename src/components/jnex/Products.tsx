...
const products: Product[] = [
  {
    ...
    shots: [
      { src: posA, caption: "Owner dashboard — sales, stock and profit at a glance" },
      { src: posB, caption: "Fast billing terminal built for busy counters" },
    ],
  ...
  },
  {
    ...
    shots: [
      { src: lmsA, caption: "Institute overview with live enrolment metrics" },
      { src: lmsB, caption: "Attendance and grading in a single table" },
    ],
